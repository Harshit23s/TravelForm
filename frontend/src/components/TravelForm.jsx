...
//     setDepartment(selected?.[0]?.department || "");
//   };
...
//           className="bg-white rounded-xl p-8 w-full max-w-2xl mx-auto shadow-lg mt-20"
...
//               className="bg-black hover:bg-gray-800 text-white py-2 px-6 rounded-full"
//             >
//               SAVE
//             </button>
//             <button
...
//           className="bg-white rounded-md p-6 max-w-md mx-auto mt-20 shadow-xl"
...
//               onChange={(e) =>
//                 setDateDetails((prev) => ({ ...prev, client: e.target.value }))
//               }
//               placeholder="Client"
//               className="w-full p-2 border rounded-md text-sm"
//             />
...
//               onChange={(e) =>
//                 setDateDetails((prev) => ({ ...prev, purpose: e.target.value }))
//               }
//               placeholder="Purpose"
//               className="w-full p-2 border rounded-md text-sm"
//             />
...
//               onChange={(e) =>
//                 setDateDetails((prev) => ({ ...prev, remarks: e.target.value }))
//               }
//               placeholder="Remarks"
//               className="w-full p-2 border rounded-md text-sm"
//             />
